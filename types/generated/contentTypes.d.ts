...
export interface ApiHeadingTagHeadingTag extends Schema.CollectionType {
  collectionName: 'heading_tags';
  info: {
    singularName: 'heading-tag';
    pluralName: 'heading-tags';
    displayName: 'HeadingTag';
    description: '';
  };
  options: {
    draftAndPublish: true;
